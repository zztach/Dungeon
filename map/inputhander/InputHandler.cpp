...
// load keys from xml file. Each key should have an associated component (e.g camera), whether it's a toggle or responds to 
// repetitive strokes 
    ...
    while (SDL_PollEvent(&event)) {
        switch (event.type) {
            ...
            case SDL_KEYUP:
                ...
                //    break;
                //}
                if (keysPressed.count(event.key.keysym.sym) && keysPressed.at(event.key.keysym.sym)->pressed == true) {
